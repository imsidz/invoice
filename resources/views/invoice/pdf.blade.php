	...
	<body>
		...
		<div class="container" style="border: 1px solid black;">
			...
			<div class="row">
				...
				<div class="col-sm-2 col-xs-2" style="padding-top: 15px;">
					<img src="companylogo/wli-logo.jpg">
				</div>
				<div class="col-sm-4 col-xs-4" style="line-height: 8px; border-right: 1px solid black;height: 110px;">
					<h4>Web Logix Infotech Pvt. Ltd</h4>
					<p><strong>Regd. Office</strong>: {{ $company->address }}</p>
					<p><strong>Tel :</strong> 
            ...
            @endforeach
				...
				<div class="col-sm-6 col-xs-6" style="line-height: 5px; margin-top: 12px; border-left: 1px;">
			...
			<div class="row" style="border-top: 1px solid black;">
				<div class="col-sm-6 col-xs-6" style="line-height: 5px;border-right: 1px solid black;">
					<div style=" margin-top: 10px">
						<p><strong>Buyer Name : </strong>{{ $client->name }}</p>
						<p><strong>GSTIN of Buyer : </strong> {{ strtoupper($client->gstin) }}</p>
			...
			<div class="row"style="border-top: 1px solid black; text-align: center;">
      ...
      @endforeach
           ...
           <p>CGST 9%</p>
			...
			<div class="row" style="border-top: 1px solid black;">
				...
				<div class="col-xs-2">
								<p><strong>Rs.{{ $invoice->total }}</strong></p>	
				</div>
			</div>
			
			<div class="row"style="border-top: 1px solid black;">
				<div class="col-sm-12 col-xs-12" style="border-right: 1px solid black;">
					...
					<div style="border: 1px solid black; padding: 13px 0px 0px 13px; width: 40%">
						<p><strong>Company GSTIN :</strong> {{ strtoupper($company->gstin) }}</p>
						<p><strong>Company PAN :</strong>  {{ strtoupper($company->pan) }}</p>
						<p><strong>Company CIN :</strong>  {{ strtoupper($company->cin) }}</p>
					</div>
			...
			<div class="row" style="border: 1px solid black;">
				...
				<div class="col-xs-10" style="border-left: 1px solid black;">
					...
					<p><strong>{{ $company->neft }}</strong></p>
			...
			<div class="row" style="border: 1px solid black;">
				<div class="col-xs-12">
					<strong><p><center>Beneficiary Name - {{ $company->companyname }}</center></p></strong>
				</div>
			</div>
	
		<div class="row" style="border: 1px solid black;">
			<div class="col-sm-2 col-xs-2" style="border-right: 1px solid black;">
				<p><strong><center>Cheque No./ Cash</center></strong></p>
			</div>
			<div class="col-sm-3 col-xs-3">
				
			</div>
			<div class="col-sm-2 col-xs-2" style="border-right: 1px solid black; border-left: 1px solid black;">
